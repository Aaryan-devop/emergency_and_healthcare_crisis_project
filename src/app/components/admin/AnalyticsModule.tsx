    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <GlassCard className="p-4">
          <h3 className="text-white font-semibold text-sm mb-4">Emergency Requests Trend (24h)</h3>
        ...
        <GlassCard className="p-4">
          <h3 className="text-white font-semibold text-sm mb-4">Ambulance Response Time (min)</h3>
          <ResponsiveContainer width="100%" height={200}>
        ...
        <GlassCard className="p-4">
          <h3 className="text-white font-semibold text-sm mb-4">Bed Occupancy Rate (%)</h3>
          <ResponsiveContainer width="100%" height={200}>
        ...
        <GlassCard className="p-4">
          <h3 className="text-white font-semibold text-sm mb-4">Blood Unit Availability (%)</h3>
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={trendData}>
              <defs>
