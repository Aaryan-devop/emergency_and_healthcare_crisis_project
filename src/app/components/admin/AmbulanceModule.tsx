  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-theme-text-primary">Ambulance Tracking</h2>
        ...
        <div className="lg:col-span-2">
          <GlassCard className="p-4 h-[380px]">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-theme-text-primary font-semibold text-sm">Live Ambulance Map</span>
            </div>
            <EmergencyMap />
          </GlassCard>
        </div>
        <div className="space-y-3">
          {(ambulanceData || []).map((amb: any) => (
            <GlassCard key={amb.id} className="p-4">
              ...
              <div className="text-theme-text-secondary text-xs font-medium mb-2">{amb.driver}</div>
